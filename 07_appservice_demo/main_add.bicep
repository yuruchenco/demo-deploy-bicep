...
var PE_SPOKE_SUBNET_NAME = 'PrivateEndpointSubnet'
 ...
 // Reference existing spoke vnet and subnet
...
// Deploy new App Service (plan and app)
module appService '../module/appservice.bicep' = {
  name: '${prefix}${abbrs.webSitesFunctions}${resourceToken}'
  params: {
...
// PRIVATE ENDPOINT
// ================================================================================================
module appServicePrivateEndopoint '../module/private-endpoint-update.bicep' = {
